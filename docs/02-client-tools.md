...
If you choose running an automated process for this step you could running this playbook :

```
cd ansible
ansible-playbook -i client-tools.yml
```

After running this playbook execute the necessary validations. 
